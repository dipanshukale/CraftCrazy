...
const NewArrivals: React.FC = () => {
  ...
  const filteredProducts = products.filter((item) => {
    const isBracelet = (item.category || "").toLowerCase() === "holi";
    ...
    <section className="mt-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       <div className="text-center mt-10 mb-8">
        ...
        <p className="mt-3 text-gray-600 text-base italic max-w-sm mx-auto">
         A festive Holi kit packed with organic colors and celebration essentials to make your Holi safe, vibrant and unforgettable.
        </p>
      </div>

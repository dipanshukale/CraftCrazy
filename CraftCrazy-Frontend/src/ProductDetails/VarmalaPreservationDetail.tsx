// src/Pages/VarmalaDetailPage.tsx
...
export default function VarmalaDetailPage() {
  ...
  const [currentVariant, setCurrentVariant] = useState<VarmalaVariant | null>(null);
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const data: VarmalaPreservation = res.data?.product;

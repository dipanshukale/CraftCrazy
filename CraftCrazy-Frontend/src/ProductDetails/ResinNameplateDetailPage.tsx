// src/Pages/ResinNameplateDetailPage.tsx
...
export default function ResinNameplateDetailPage() {
  ...
  const [currentProduct, setCurrentProduct] = useState<ResinNameplate | null>(null);
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const data: ResinNameplate = res.data?.product;

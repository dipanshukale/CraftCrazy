...
export default function HaldiPlatterDetailPage() {
  ...
  const [currentProduct, setCurrentProduct] = useState<HaldiPlatter | null>(null);
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 mt-4 items-center">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium shadow-lg ${
                currentVariant?.inStock ? "bg-[#C45A36] hover:bg-[#8c4a20] text-white" : "bg-gray-300 text-gray-600 cursor-not-allowed"
              }`}
            >

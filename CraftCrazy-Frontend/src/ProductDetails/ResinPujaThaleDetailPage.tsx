// src/Pages/ResinPujaThaleDetailPage.tsx
...
export default function ResinPujaThaleDetailPage() {
  ...
  const [currentProduct, setCurrentProduct] = useState<ResinPujaThale | null>(null);
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const data: ResinPujaThale = res.data?.product;
